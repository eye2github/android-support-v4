...
public class Switch extends CompoundButton {
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
		...
		//
		// typefaceIndex =
		// appearance.getInt(R.styleable.TextAppearance_typeface, -1);
		// styleIndex = appearance.getInt(R.styleable.TextAppearance_textStyle,
		// -1);
		//
		// setSwitchTypefaceByIndex(typefaceIndex, styleIndex);
		//
		// boolean allCaps =
		// appearance.getBoolean(R.styleable.TextAppearance_textAllCaps, false);
		// // if (allCaps) {
    ...
    private Layout makeLayout(CharSequence text) {
        ...
        return new StaticLayout(transformed, mTextPaint, (int)Math.ceil(Layout.getDesiredWidth(
                transformed, mTextPaint)), Layout.Alignment.ALIGN_NORMAL, 1.f, 0, true);
    }
