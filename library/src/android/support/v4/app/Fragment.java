...
public class Fragment implements ComponentCallbacks,
	...
	public static Fragment instantiate(Context context, String fname,
		...
		try {
			...
			throw new InstantiationException("Unable to instantiate fragment "
					+ fname
	...
	public void setInitialSavedState(SavedState state) {
		...
		mSavedFragmentState = state != null && state.mState != null ? state.mState
				: null;
	}
	...
	public LoaderManager getLoaderManager() {
		...
		mLoaderManager = mActivity.getLoaderManager(mIndex, mLoadersStarted,
				true);
		return mLoaderManager;
	}
	...
	public void onStart() {
		...
		if (!mLoadersStarted) {
			...
			if (!mCheckedForLoaderManager) {
				mCheckedForLoaderManager = true;
				mLoaderManager = mActivity.getLoaderManager(mIndex,
