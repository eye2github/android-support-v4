...
public class FragmentBreadCrumbs extends ViewGroup
    ...
    public FragmentBreadCrumbs(Context context, AttributeSet attrs) {
        this(context, attrs, R.style.FragmentBreadCrumbs);
    }
    ...
    public void setActivity(FragmentActivity a) {
        ...
        mContainer = (LinearLayout)mInflater.inflate(
                R.layout.fragment_bread_crumbs,
                this, false);
        addView(mContainer);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            int childRight = getPaddingLeft() + child.getMeasuredWidth() - getPaddingRight();
            int childBottom = getPaddingTop() + child.getMeasuredHeight() - getPaddingBottom();
        ...
        for (int i = 0; i < numEntries + numPreEntries; i++) {
            ...
            if (i >= numViews) {
                final View item = mInflater.inflate(
                        R.layout.fragment_bread_crumb_item,
                        this, false);
