...
public class PreferenceManager {
	 ...
	 * inflating the hierarchy. Do not set this directly, use
	 * {@link #setNoCommit(boolean)}
	 */
	...
	/**
	 * This constructor should ONLY be used when getting default values from an
	 * XML preference hierarchy.
	 * <p>
	 * The {@link PreferenceManager#PreferenceManager(Activity)} should be used
	 * ANY time a preference will be displayed, since some preference types need
	 * an Activity for managed queries.
	 */
	 ...
	 * <p>
	 * If {@code readAgain} is false, this will only set the default values if
	 * this method has never been called in the past (or the
